...
app.get("/", async (c) => {
    try {
        ...
        let tierTickets = 0;
        if (activeReferralCount >= 15)
            tierTickets = 10;
        else if (activeReferralCount >= 10)
            tierTickets = 5;
        else if (activeReferralCount >= 5)
            tierTickets = 2;
        const referralsToNextTier = activeReferralCount < 5 ? 5 - activeReferralCount
            : activeReferralCount < 10 ? 10 - activeReferralCount
                : activeReferralCount < 15 ? 15 - activeReferralCount
                    : 0;
